module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('msg' in setting)) setting.msg = 'Hi +tag 🍃¸\An automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : PostgreSQL\n◦ *Library* : @whiskeysockets/baileys^6.6.0\n◦ *Instagram* : https://www.instagram.com/faaaarr__/\n\nIf you find an error or want to upgrade premium plan contact the owner.'
