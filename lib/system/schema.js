module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('sk_author' in setting)) setting.sk_author = 'Â© asuna-bot'
      ...
      if (!('owners' in setting)) setting.owners = ['447389642772']
      if (!isNumber(setting.lastReset)) setting.lastReset = new Date * 1
      if (!('msg' in setting)) setting.msg = 'Hi +tag ðŸª¸\An automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : PostgreSQL\n◦ *Library* : @whiskeysockets/baileys^6.6.0\n◦ *Instagram* : https://www.instagram.com/faaaarr__/\n\nIf you find an error or want to upgrade premium plan contact the owner.'
      if (!isNumber(setting.style)) setting.style = 3
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/33aec2c7bff0ac5d0d046.jpg'
      ...
      global.db.setting = {
         ...
         style: 3,
         cover: 'https://telegra.ph/file/33aec2c7bff0ac5d0d046.jpg',
